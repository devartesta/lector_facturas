...
DEFAULT_ADMIN_LINES = ("CONTINUUM", "DELAWARE", "HUSHED", "IPOSTAL", "QUICKBOOKS", "REGUS")
...
def _fill_inc_formulas(
    ...
    *,
    ...
    for col in [get_column_letter(i) for i in range(4, 16)]:
        ...
        ws[f"{col}{pos['profit']}"] = f"={col}{pos['turnover']}-{col}{pos['cogs']}-{col}{pos['opex']}-{col}{pos['diferencias_divisas']}-{col}{pos['royalties']}"
